...
<link rel="stylesheet" type="text/css" href="../js/jquery-easyui-1.4.4/themes/gray/easyui.css"/>
<script src="../js/jquery-easyui-1.4.4/jquery.min.js" type="text/javascript"></script>
<script src="../js/jquery-easyui-1.4.4/jquery.easyui.min.js" type="text/javascript"></script>
...
.container{width:100%; height:420px;margin:0px auto;clear:both;position:relative;background:url(../image/login_bg.jpg);}
...
.background{width:1200px; height:100%;position:relative;margin-left:auto; margin-right:auto;background:url(../image/login_cbg.jpg);backgroud-repea:no-repeat;}
...
function changecode(){
	$("#kaptchaImage").hide().attr('src', '../kaptcha.do?' + Math.floor(Math.random()*100) ).fadeIn();
...
<div id="login">
	<div class="header">
		<div class="header_left"><img src="../image/login_logo.jpg" style="position:absolute; bottom:0px; width:100%; height:50%;" ></div>
	</div>
	<div class="container">
			...
			<form  method="post" action="" id="login_Form"> <!-- action填目标文件地址 -->
				<table width="350" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td align="left" height="40"><input class="easyui-textbox" type="text" name="login_code" id="login_code" style="width:80px;">&nbsp;<img align=center alt="刷新" id="kaptchaImage" src="../kaptcha.do" style="cursor:pointer;" onclick="changecode()"/> <a href="Javascript:void(0);"  onclick="changecode()" style="font-size:8pt;">看不清？</a></td>
					</tr>
					<tr>
						<td height="74">&nbsp;</td>
								<td><div style="float:left">
										<img name="login_signin" id="login_signin" alt="登录" src="../image/signin.png" onclick="checkForm()" style="cursor:pointer;" />&nbsp;										
									</div>
