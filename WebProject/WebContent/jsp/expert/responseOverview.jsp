...
$(function () {
            ...
            $('#roleList').datagrid({
				...
				columns: [[
				//{field : 'questionID', title : '编号',width :160,align:'center'},
				{field : 'qdescription', title : '内容',width :336,align:'center'},
				{field : 'field',title : '领域',width : 160,align:'center',sortable:true}, 
				{field : 'qtime',title : '时间',width : 208,align:'center',sortable:true},
				 { field: 'opt', title: '详情了解', width: 160, align: 'center',
                    formatter: function (value,row,index) {
                    	return "<a href='<%=request.getContextPath()%>/expertresponsego.do?questionid="+ row.questionID +"'>查看详情</a>";
                    }
                }
                ...
                onSortColumn:function(sort, order){
                	...
                	$.ajax({
                        url:'<%=request.getContextPath()%>/loadexpertqagrid.do',
