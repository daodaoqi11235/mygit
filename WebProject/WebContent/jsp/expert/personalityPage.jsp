<%@ page import="com.hibernate.beans.Expert"%>
...
<%Expert exp=(Expert) request.getAttribute("ExpertInfo"); System.out.println(exp.getAchievement().length());%>	 
...
<body>
 ...
 <div class="commonPage">
    ...
    <div class="context">
	   ...
	   <div >
	   	<form action="<%=request.getContextPath() %>/expertinformationupdate.do" name="Form1" id="Form1" method="post">
	   	 ...
	   	 <tr><td style="height:320px;">
	     	...
	     	<table class="prodTab" align="center" border="thick" bordercolor="#DEE5EA" cellspacing="0" cellpadding="0">
               ...
               <tr >
                    ...
                    <td>
                        <b><%=exp.getCellphone() %></b>
                    </td>
                </tr>
                <tr >
                    <td style="background-color:#F2F2F2;">移动电话：</td>
                    <td>
                       <b><%=exp.getTelephone() %></b>
                    </td>
                </tr>
                 <tr >
             ...
             <tr><td id="tabtext1" align="center"><div style="margin-top:20px;height:100%;">
					<textarea id="achievement" cols="40" rows="12"  name="achievement" style="width:90%;height:90%;"><%=exp.getAchievement() %></textarea>
	             </div>
             </td></tr>
